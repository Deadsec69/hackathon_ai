...
def simulate_cpu_spike():
    ...
    print(f"[CPU Spike] Creating {num_cores} threads to maximize CPU usage")  # Reduced from num_cores * 2 to num_cores
    ...
    print(f"[CPU Spike] All threads started, will run for 30 seconds")  # Reduced from 60 seconds to 30 seconds
